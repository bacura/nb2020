...
<div class='container-fluid'>
	...
	<div class='row'>
		<div class='col-10' align='center'><button class='btn btn-outline-danger' type='button' onclick=\"updateUintc()\">#{lp[5]}</button></div>
		<div class='col-2' align='center'>
			<a href='gm-export.cgi?extag=unit' download='unit.txt'><button type='button' class='btn btn-outline-primary'>#{lp[6]}</button></a>
		</div>
	</div>
</div>
<hr>
