...
HTML
	...
	when 'chart'
		...
		html << "#{lp[109]}<br>"
		html << '1st period<br>'
		html << "<input type='text' class='form-control form-control-sm' id='aveep1' value='' DISABLED><br>"
		html << '2nd period<br>'
		html << "<input type='text' class='form-control form-control-sm' id='aveep2' value='' DISABLED><br>"
		html << '3rd period<br>'
		html << "<input type='text' class='form-control form-control-sm' id='aveep3' value='' DISABLED><br>"
		html << 'Fianl period<br>'
		html << "<input type='text' class='form-control form-control-sm' id='aveep4' value='' DISABLED><br>"

		html << '</div>'
		html << "<div class='col-10'><div id='physique_#{@module}-chart' align='center'></div></div>"
...
//	$.post( "physique.cgi", { mod:'#{@module}', step:'raw', start_date:start_date, pal:pal, eenergy:eenergy }, function( data ){ $( "#L3" ).html( data );});
