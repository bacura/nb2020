...
source_file = '20201225-mxt_kagsei-mext_01110-FIB-m20211227.txt'
out_file = '20201225-mxt_kagsei-mext_01110-FIB-m20211227_clean.txt'
...
data_solid.each do |e|
	...
	if /^\d\d/ =~ e && a.size >= 5
		...
		c -= 1
		data_solid_[c].chomp! unless data_solid_[c] == nil
		data_solid_[c] << "<br>#{t}" unless data_solid_[c] == nil
	end
	c += 1
end
