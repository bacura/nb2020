...
def cfg_init()
	...
	if res.first
		...
		query = 'CREATE TABLE cfg (user VARCHAR(32) NOT NULL PRIMARY KEY, cfgj VARCHAR(4096), recipe VARCHAR(256), menul VARCHAR(32), history VARCHAR(128), calcc VARCHAR(64), icalc TINYINT, koyomi VARCHAR(1000), icache TINYINT(1), ifix TINYINT(1), bio VARCHAR(255), fcze VARCHAR(128), media VARCHAR(128), school VARCHAR(512), allergen VARCHAR(3));'
		$DB.query( query )
